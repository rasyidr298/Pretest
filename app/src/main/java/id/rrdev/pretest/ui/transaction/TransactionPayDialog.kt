...
import id.rrdev.pretest.MyApp
import id.rrdev.pretest.MyApp.Companion.prefManager
import id.rrdev.pretest.data.response.DataProduct
import id.rrdev.pretest.databinding.DialogProductInputBinding
import id.rrdev.pretest.databinding.DialogTransactionPayBinding
...
class TransactionPayDialog(
    ...
    private fun setupView() {
        with(binding) {
            val totalPrice = MyApp.prefManager.spTotalPrice
